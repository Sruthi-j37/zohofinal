...
# -----------------------------------bank_holder--------------------------------sruthi--------------------------
    ...
    path('zohomodules/bankholder/sort_holder_by_name',views.sort_holder_by_name,name='sort_holder_by_name'),
    path('zohomodules/bankholder/sort_holder_by_bank',views.sort_holder_by_bank,name='sort_holder_by_bank'),
    path('zohomodules/bankholder/active_holders',views.active_holders,name='active_holders'),
    path('zohomodules/bankholder/inactive_holders',views.inactive_holders,name='inactive_holders'),
    path('zohomodules/bankholder/create_holder',views.createholder,name='createholder'),
    path('zohomodules/bankholder/create_holder',views.createbank,name='createbank'),
    path('zohomodules/bankholder/create_bankholder',views.create_bankholder,name='create_bankholder'),
    path('zohomodules/bankholder/overview_bankholder',views.overview_bankholder,name='overview_bankholder'),
