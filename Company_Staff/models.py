...
class BankAccount(models.Model):
    ...
    cheque_book_range = models.CharField(max_length=10)
    enable_cheque_printing = models.CharField(max_length=10)
    cheque_printing_configuration = models.CharField(max_length=10)
    ...
    alter_gst_details = models.CharField(max_length=80, blank=True)
    date = models.DateField()
